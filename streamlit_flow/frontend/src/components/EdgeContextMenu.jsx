        ...
        <Row className="g-2 mt-1 mt-md-0">
          <Col md>
            <Form.Check
              ...
              id="edgeAnimated"
              label="Animated"
              defaultChecked={editedEdge.animated}
          ...
          <Col md>
            <Form.Check
              ...
              id="edgeDeletable"
              label="Deletable"
              defaultChecked={editedEdge.deletable}
              onChange={onEdgeDeletableChange}
            />
          </Col>
          <Col md>
            <Form.Check
              ...
              id="edgeLabelShowBg"
              label="Label BG"
              defaultChecked={editedEdge.labelShowBg}
              onChange={onEdgeLabelShowBgChange}
            />
          </Col>
        </Row>
      </Modal.Body>
      ...
      >
        {!showModal && !modalClosing && (
          <ButtonGroup vertical>
            <Button variant="outline-primary" onClick={handleEditEdge}>
              <i className="bi bi-tools"></i> Edit Edge
            </Button>
            <Button
              variant={edgeContextMenu.edge.deletable ? 'outline-danger' : 'secondary'}
              onClick={handleDeleteEdge}
              disabled={!edgeContextMenu.edge.deletable}
            >
